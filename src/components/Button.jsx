export default function Button({ children, className = "", variant = "primary", disabled, ...props }) {
  ...
  const variants = {
    ...
    outline: "border border-slate-300 text-slate-700 hover:bg-brand-50 focus-visible:ring-brand-300",
    subtle: "bg-white border border-slate-200 text-slate-800 hover:shadow-md focus-visible:ring-brand-300",
  };
  return (
